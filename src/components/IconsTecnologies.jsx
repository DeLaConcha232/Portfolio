...
export default function IconsTech() {
  ...
  const array = [
    ...
    { 
      id: 1,
      subtitle: 'Ecommerce site about everything related to sports',
      title: 'Ecommerce page DeportivaX <RESPONSIVE>',
      img1: '/assets/Proyects/DeportivaxMovil.png',
      subtitle2: 'To know how many calories and macros you need to consume daily',
      title2: 'Calories and Macros calculator <RESPONSIVE>',
      img2: '/assets/Proyects/bodycalculatorMovil.png',
      subtitle3: 'Copia de practica de interfaz UI de una pagina Gubernamental',
      title3: 'Gubernamental page Clon Curp',
      img3: '/assets/Proyects/CurpClonMovil.png',
      subtitle4: 'To know your Body mass index',
      title4: 'IMC calculator <RESPONSIVE>',
      img4: '/assets/Proyects/IMC-calculator.png',
      subtitle5: 'ccs',
      title5: '',
    ...
    {
      id: 3,
      subtitle: 'To know how many calories and macros you need to consume daily',
      title: 'Calories and Macros calculator <RESPONSIVE>',
      img1: '/assets/Proyects/bodycalculatorMovil.png',
      subtitle2: 'To know your Body mass index',
      title2: 'IMC calculator <RESPONSIVE>',
      img2: '/assets/Proyects/IMC-calculator.png',
      subtitle3: '',
      title3: '',
    ...
    // GODOT
    {
      ...
      title4: '',
      img4: '',
      subtitle5: 'VideoGame kind of Mario Bros',
      title5: 'Gemada VideoGame <RESPONSIVE>',
    ...
    // VITE
    {
      ...
      title2: 'Calories and Macros calculator <RESPONSIVE>',
      img2: '/assets/Proyects/bodycalculatorMovil.png',
      subtitle3: 'To know your Body mass index',
      title3: 'IMC calculator <RESPONSIVE>',
      img3: '/assets/Proyects/IMC-calculator.png',
      subtitle4: '',
      title4: '',
      img4: '/assets/Proyects/',
      subtitle5: '',
